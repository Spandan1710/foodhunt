    ...
    <div class="row content">
        ...
        <div class="col-sm-8 text-left">
            <div class="container">
                ...
                <form action="AddMenuItemController" method="post">
                    ...
                    <button type="submit" name="submit" value="addMenuItem" class="btn btn-success btn-lg">Add</button>
                    <a type="button" href="restaurantDetail.jsp?restaurantID=<%=request.getParameter("restaurantID")%>"
